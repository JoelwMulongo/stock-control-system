...
Private Sub Quantity_AfterUpdate()
    ...
    rst.Seek "=", Me!ItemID
    'Error message if quantity entered is less than reorder level
    If Me!Quantity < rst("ReorderLevel") Then
        MsgBox "The minimum quantity of " & Me!ItemName & " that can be ordered is " & rst("ReorderLevel") & _
        ". Enter a value greater or equal to it.", _
